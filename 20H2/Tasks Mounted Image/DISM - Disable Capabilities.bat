...
DISM /image:%MOUNT% /Remove-Capability /CapabilityName:Microsoft.Windows.Notepad~~~~0.0.1.0
...
DISM /image:%MOUNT% /Remove-Capability /CapabilityName:Microsoft.Windows.MSPaint~~~~0.0.1.0
